...
@section('admin-content')
    <div class="page-titles">
        <ol class="breadcrumb">
            <li>
                <h5 class="bc-title">About List</h5>
            </li>
                                ...
                                <tbody>
                                    @foreach ($about as $key => $item)
                                        <tr>
                                            ...
                                            <td>{{ ucfirst($item->short_about) }}</td>
                                            <td>{{ ucfirst($item->long_about) }}</td>
                                            <td><img src="{{ asset('uploads/about/' . $item->about_image) }}" alt=""
                                                    style="width: 80px"></td>
                                            <td style="text-align: end">
                                                ...
                                                <a href="{{ route('about.destroy', $item->id) }}" id="delete"
