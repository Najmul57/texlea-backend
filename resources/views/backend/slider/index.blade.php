                            ...
                            <table id="empoloyees-tbl1" class="table">
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td><img src="{{ asset('uploads/slider/'.$slider->slide) }}" alt="" style="width: 80px"></td>
                                        <td>{{ ucfirst($slider->title)}}</td>
                                        <td>
                                            <a href="{{ route('slider.edit',$slider->id) }}" class="btn btn-sm btn-primary"><i class="fa fa-edit"></i></a>
                                            <a href="{{ route('slider.destroy',$slider->id) }}" id="delete" class="btn btn-sm btn-danger"><i class="fa fa-trash"></i></a>
                                        </td>
                                    </tr>
                                @endforeach                                
                                </tbody>
