...
@section('admin-content')
    ...
    <div class="page-titles">
        <ol class="breadcrumb">
            <li>
                <h5 class="bc-title">Global Location Create</h5>
            </li>
            ...
            <div class="col-12 col-md-6 col-sm-12 mx-auto">
                <div class="card">
                    <div class="card-body p-3">
                        <form action="{{ route('global_location.store') }}" method="post" enctype="multipart/form-data">
                            @csrf
                            ...
                            <div class="form-group my-3">
                                ...
                                <textarea name="feature" id="editor" class="form-control" cols="30" rows="10"></textarea>
                            </div>
