									...
									<div class="dropdown-menu dropdown-menu-end" style="">
										<div class="card border-0 mb-0">
											<div class="card-header py-2">
												<div class="products">
													<img src="{{ asset('backend') }}/images/tab/1.jpg" class="avatar avatar-md" alt="">
													<div>
														<h6>Thomas Fleming</h6>
									...
									<table id="projects-tbl" class="table ItemsCheckboxSec">
										...
										<tbody>
											<tr>
												...
												<td>
													<div class="d-flex align-items-center">
														<img src="{{ asset('backend') }}/images/contacts/pic1.jpg"
												...
												<td class="pe-0">
													<div class="avatar-list avatar-list-stacked">
														<img src="{{ asset('backend') }}/images/contacts/pic1.jpg"
															class="avatar rounded-circle" alt="">
														<img src="{{ asset('backend') }}/images/contacts/pic555.jpg"
															class="avatar rounded-circle" alt="">
														<img src="{{ asset('backend') }}/images/contacts/pic666.jpg"
															class="avatar rounded-circle" alt="">
													</div>
												</td>
												<td class="pe-0">
											...
											<tr>
												...
												<td class="pe-0">
													<div class="avatar-list avatar-list-stacked">
														<img src="{{ asset('backend') }}/images/contacts/pic1.jpg"
															class="avatar rounded-circle" alt="">
														<img src="{{ asset('backend') }}/images/contacts/pic777.jpg"
															class="avatar rounded-circle" alt="">
														<img src="{{ asset('backend') }}/images/contacts/pic666.jpg"
															class="avatar rounded-circle" alt="">
													</div>
											...
											<tr>
												...
												<td>
													<div class="d-flex align-items-center">
														<img src="{{ asset('backend') }}/images/contacts/pic2.jpg"
															class="avatar rounded-circle" alt="">
											...
											<tr>
												...
												<td>
													<div class="d-flex align-items-center">
														<img src="{{ asset('backend') }}/images/contacts/pic888.jpg"
															class="avatar rounded-circle" alt="">
											...
											<tr>
												...
												<td>
													<div class="d-flex align-items-center">
														<img src="{{ asset('backend') }}/images/contacts/pic999.jpg"
															class="avatar rounded-circle" alt="">
														<p class="mb-0 ms-2">Elijah James</p>
													</div>
												</td>
									...
									<div class="col-xl-4 active-country dz-scroll">
										<div class="">
											<div class="country-list">
												<img src="{{ asset('backend') }}/images/country/india.png" alt="">
												<div class="progress-box mt-0">
													<div class="d-flex justify-content-between">
											...
											<div class="country-list">
												<img src="{{ asset('backend') }}/images/country/canada.png" alt="">
												<div class="progress-box mt-0">
													<div class="d-flex justify-content-between">
											...
											<div class="country-list">
												<img src="{{ asset('backend') }}/images/country/russia.png" alt="">
												<div class="progress-box mt-0">
													<div class="d-flex justify-content-between">
											...
											<div class="country-list">
												<img src="{{ asset('backend') }}/images/country/uk.png" alt="">
												<div class="progress-box mt-0">
													<div class="d-flex justify-content-between">
											...
											<div class="country-list">
												<img src="{{ asset('backend') }}/images/country/aus.png" alt="">
												<div class="progress-box mt-0">
													<div class="d-flex justify-content-between">
											...
											<div class="country-list">
												<img src="{{ asset('backend') }}/images/country/usa.png" alt="">
												<div class="progress-box mt-0">
													<div class="d-flex justify-content-between">
											...
											<div class="country-list">
												<img src="{{ asset('backend') }}/images/country/pak.png" alt="">
												<div class="progress-box mt-0">
													<div class="d-flex justify-content-between">
											...
											<div class="country-list">
												<img src="{{ asset('backend') }}/images/country/germany.png" alt="">
												<div class="progress-box mt-0">
													<div class="d-flex justify-content-between">
											...
											<div class="country-list">
												<img src="{{ asset('backend') }}/images/country/uae.png" alt="">
												<div class="progress-box mt-0">
													<div class="d-flex justify-content-between">
											...
											<div class="country-list">
												<img src="{{ asset('backend') }}/images/country/china.png" alt="">
												<div class="progress-box mt-0">
													<div class="d-flex justify-content-between">
								...
								<div class="chat-box-area style-1 dz-scroll" id="chartBox2">
									<div class="media">
										<div class="message-received w-auto">
											<div class="d-flex">
												<img src="{{ asset('backend') }}/images/contacts/pic2.jpg" class="avatar rounded-circle"
													alt="">
												<div class="ms-1 text">
										...
										<tbody>
											<tr>
												<td>
													<div class="form-check custom-checkbox">
														<input type="checkbox" class="form-check-input"
															id="customCheckBox220" required="">
														<label class="form-check-label" for="customCheckBox220"></label>
													</div>
												</td>
												<td>
													<div class="products">
														<img src="{{ asset('backend') }}/images/contacts/d1.jpg" class="avatar avatar-md"
															alt="">
														<div>
											...
											<tr>
												<td>
													<div class="form-check custom-checkbox">
														<input type="checkbox" class="form-check-input"
															id="customCheckBox123" required="">
														<label class="form-check-label" for="customCheckBox123"></label>
													</div>
												</td>
												<td>
													<div class="products">
														<img src="{{ asset('backend') }}/images/contacts/d2.jpg" class="avatar avatar-md"
															alt="">
														<div>
											...
											<tr>
												...
												<td>
													<div class="products">
														<img src="{{ asset('backend') }}/images/contacts/d3.jpg" class="avatar avatar-md"
															alt="">
														<div>
											...
											<tr>
												...
												<td>
													<div class="products">
														<img src="{{ asset('backend') }}/images/contacts/d4.jpg" class="avatar avatar-md"
															alt="">
														<div>
											...
											<tr>
												...
												<td>
													<div class="products">
														<img src="{{ asset('backend') }}/images/contacts/d5.jpg" class="avatar avatar-md"
															alt="">
														<div>
											...
											<tr>
												...
												<td>
													<div class="products">
														<img src="{{ asset('backend') }}/images/contacts/d6.jpg" class="avatar avatar-md"
															alt="">
														<div>
											...
											<tr>
												...
												<td>
													<div class="products">
														<img src="{{ asset('backend') }}/images/contacts/d7.jpg" class="avatar avatar-md"
															alt="">
														<div>
											...
											<tr>
												...
												<td>
													<div class="products">
														<img src="{{ asset('backend') }}/images/contacts/d8.jpg" class="avatar avatar-md"
															alt="">
														<div>
											...
											<tr>
												...
												<td>
													<div class="products">
														<img src="{{ asset('backend') }}/images/contacts/d14.jpg" class="avatar avatar-md"
															alt="">
														<div>
											...
											<tr>
												...
												<td>
													<div class="products">
														<img src="{{ asset('backend') }}/images/contacts/d13.jpg" class="avatar avatar-md"
															alt="">
														<div>
											...
											<tr>
												...
												<td>
													<div class="products">
														<img src="{{ asset('backend') }}/images/contacts/d9.jpg" class="avatar avatar-md"
															alt="">
														<div>
											...
											<tr>
												<td>
													<div class="form-check custom-checkbox">
														<input type="checkbox" class="form-check-input"
															id="customCheckBox133" required="">
														<label class="form-check-label" for="customCheckBox133"></label>
													</div>
												</td>
												<td>
													<div class="products">
														<img src="{{ asset('backend') }}/images/contacts/d10.jpg" class="avatar avatar-md"
															alt="">
														<div>
											...
											<tr>
												...
												<td>
													<div class="products">
														<img src="{{ asset('backend') }}/images/contacts/d11.jpg" class="avatar avatar-md"
															alt="">
														<div>
											...
											<tr>
												...
												<td>
													<div class="products">
														<img src="{{ asset('backend') }}/images/contacts/d12.jpg" class="avatar avatar-md"
															alt="">
														<div>
									...
									<div class="tbl-caption">
										...
										<div>
											...
											<button type="button" class="btn btn-secondary btn-sm"
												data-bs-toggle="modal" data-bs-target="#exampleModal1">+ Invite Employee
											</button>
										</div>
									</div>
									<table id="empoloyees-tbl" class="table">
										...
										<tbody>
											<tr>
												...
												<td>
													<div class="products">
														<img src="{{ asset('backend') }}/images/contacts/pic1.jpg" class="avatar avatar-md"
															alt="">
														<div>
											...
											<tr>
												...
												<td>
													<div class="products">
														<img src="{{ asset('backend') }}/images/contacts/pic2.jpg" class="avatar avatar-md"
															alt="">
														<div>
															<h6><a href="javascript:void(0)">Ricky Antony</a></h6>
															<span>Web Designer</span>
											...
											<tr>
												...
												<td>
													<div class="products">
														<img src="{{ asset('backend') }}/images/contacts/pic3.jpg" class="avatar avatar-md"
															alt="">
														<div>
