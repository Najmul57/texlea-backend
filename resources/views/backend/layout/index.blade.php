                        ...
                        <div class="card chart-grd same-card">
                            <div class="card-body depostit-card p-0">
                                <div class="depostit-card-media d-flex justify-content-between">
                                    <div>
                                        @php
                                            $certificate=\App\Models\Certificate::count();
                                        @endphp
                                        <h6>Total Certficate</h6>
                                        <h3>{{ $certificate }}</h3>
                                    </div>
                                </div>
                            </div>
                        ...
                        <div class="card chart-grd same-card">
                            <div class="card-body depostit-card p-0">
                                <div class="depostit-card-media d-flex justify-content-between">
                                    <div>
                                        @php
                                        $subcategory=\App\Models\Subcategory::count();
                                    @endphp
                        ...
                        <div class="card chart-grd same-card">
                            <div class="card-body depostit-card p-0">
                                <div class="depostit-card-media d-flex justify-content-between">
                                    <div>
                                        @php
                                        $childcategory=\App\Models\ChildCategory::count();
                                    @endphp
                                        <h6>Total ChildCategory</h6>
                                        <h3>{{ $childcategory }}</h3>
                                    </div>
                                </div>
                            </div>
